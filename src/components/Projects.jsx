    ...
    <section id="projects" className="section container">
      ...
      {selectedProject && (
        <div style={{
          ...
          <div className="glass-panel" style={{ maxWidth: '800px', width: '100%', overflow: 'hidden' }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: '2rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
                <h3 style={{ fontSize: '2rem' }}>{selectedProject.title}</h3>
                <button onClick={() => setSelectedProject(null)} style={{ background: 'none', border: 'none', color: 'white', cursor: 'pointer' }}>
                  <X size={24} />
                </button>
              </div>
