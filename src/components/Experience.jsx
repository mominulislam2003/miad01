  ...
  return (
    <section id="experience" className="section container">
      ...
      <div style={{ position: 'relative', maxWidth: '800px', margin: '0 auto' }}>
        <div style={{ position: 'absolute', left: '20px', top: 0, bottom: 0, width: '2px', background: 'var(--border-glass)' }}></div>
        
        {portfolioData.experience.map((exp, index) => (
          <div key={exp.id} style={{ display: 'flex', gap: '2rem', marginBottom: '2rem', position: 'relative' }}>
            <div style={{
              width: '40px',
              height: '40px',
              borderRadius: '50%',
